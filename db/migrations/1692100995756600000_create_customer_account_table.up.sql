...
COMMENT ON TABLE customer_account IS 'links customer with account with many to many relationship. multiple customer can own a single account .short code is cac.';