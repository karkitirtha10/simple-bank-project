...
func (a JWTService) ClaimsFromToken(tokenString string, publicKey string) (jwt.MapClaims, error) {
	...
	/////////
	// token, err := jwt.Parse(tokenString, func(token *jwt.Token) (interface{}, systemerror) {
...
type IJWTService interface {
	...
	ClaimsFromToken(tokenString string, publicKey string) (jwt.MapClaims, error)
}
...
func NewJWTService(rsaGenerator IRSAGenerator) IJWTService {
	return &JWTService{rsaGenerator}
}
